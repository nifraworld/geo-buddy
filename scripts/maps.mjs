...
function bdBuild() {
  ...
  writeFileSync(
    ...
    "/* GENERATED by scripts/maps.mjs. WGS84 upazila source dissolved into 8 divisions. */\n" +
      "var BD_PROJ = " + JSON.stringify({ type: "mercator", scale: proj.scale(), translate: proj.translate() }) + ";\n" +
...
function worldBuild() {
  ...
  writeFileSync(
    ...
    "/* GENERATED by scripts/maps.mjs. Natural Earth 1:50m, Equal Earth projection, ids are ISO 3166-1 numeric codes. */\n" +
      ...
      "var WORLD_PROJ = " + JSON.stringify({ type: "equalEarth", scale: proj.scale(), translate: proj.translate() }) + ";\n"
  );
